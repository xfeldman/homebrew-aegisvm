...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.1.7/aegisvm-v0.1.7-darwin-arm64.tar.gz"
  sha256 "f0d3fd2a80ef4677b747b48cf589ac5d03ebb685c3c1cc7d4b5f11b5cb832f5e"
  version "0.1.7"
  license "Apache-2.0"
