...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.5.5/aegisvm-v0.5.5-darwin-arm64.tar.gz"
  sha256 "6b0c21de91f3175512b7dc678b36113529b229cd581157c713636f2f05a158c4"
  version "0.5.5"
  license "Apache-2.0"
