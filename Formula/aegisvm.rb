...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.5.8/aegisvm-v0.5.8-darwin-arm64.tar.gz"
  sha256 "a6e1bfa9f40deb1d3a256e4f5aacf6d30d980ae88ce0f392f586a63bffe311be"
  version "0.5.8"
  license "Apache-2.0"
