...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.5.16/aegisvm-v0.5.16-darwin-arm64.tar.gz"
  sha256 "87d76167d09507dede30c0eb9a6ce984286418059dd932a91bb8d9b540a32f7e"
  version "0.5.16"
  license "Apache-2.0"
