...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.3.5/aegisvm-v0.3.5-darwin-arm64.tar.gz"
  sha256 "d104798d10854a464eef3b7a8776691396aa388dd6d405a6ec0c4cec8831e2f0"
  version "0.3.5"
  license "Apache-2.0"
