...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.3.2/aegisvm-v0.3.2-darwin-arm64.tar.gz"
  sha256 "ecf8da16bc92f23914d5e3c131db5f37ad930e14615bf05ff0a6e87d88ea6135"
  version "0.3.2"
  license "Apache-2.0"
