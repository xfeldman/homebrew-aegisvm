...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.3.1/aegisvm-v0.3.1-darwin-arm64.tar.gz"
  sha256 "7a313da307915a408721d530d41ccc4f0a94bdc9e754287e41010280af3d1546"
  version "0.3.1"
  license "Apache-2.0"
