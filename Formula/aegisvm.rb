...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.4.6/aegisvm-v0.4.6-darwin-arm64.tar.gz"
  sha256 "c61ca01321cf96a61bc08f739daeedf0a9bf330b318a35658da9d9470f6813a8"
  version "0.4.6"
  license "Apache-2.0"
