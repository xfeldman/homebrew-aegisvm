...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.5.15/aegisvm-v0.5.15-darwin-arm64.tar.gz"
  sha256 "a9814f604ca659e241a8b9cc47b42d1623283379a6c094811a2b896ab32f87ab"
  version "0.5.15"
  license "Apache-2.0"
