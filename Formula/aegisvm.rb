...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.1.3/aegisvm-v0.1.3-darwin-arm64.tar.gz"
  sha256 "91b77509901597bb8f3e81083814fe4d7300aad93914f11a943ca1c710b9dddb"
  version "0.1.3"
  license "Apache-2.0"
