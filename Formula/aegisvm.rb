...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.3.3/aegisvm-v0.3.3-darwin-arm64.tar.gz"
  sha256 "f750221f5fdff878ea5faea70d69da1421f823379833717aa870238e75bc577f"
  version "0.3.3"
  license "Apache-2.0"
