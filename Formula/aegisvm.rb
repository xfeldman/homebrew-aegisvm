...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.1.2/aegisvm-v0.1.2-darwin-arm64.tar.gz"
  sha256 "fbb62711dd65d8ec0db7452506fee86c9febea117294d5f36934a13baaeaab63"
  version "0.1.2"
  license "Apache-2.0"
