...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.5.14/aegisvm-v0.5.14-darwin-arm64.tar.gz"
  sha256 "1271b53d355f0120a3a8129aa9a1309013b9b67187748fb7ebb0e29622d11f0b"
  version "0.5.14"
  license "Apache-2.0"
