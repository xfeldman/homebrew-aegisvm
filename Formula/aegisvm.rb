...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.4.4/aegisvm-v0.4.4-darwin-arm64.tar.gz"
  sha256 "3a9689d48a8ef6da8ce0372c23b5619946cfff9c04ab9f2083dde48bc254b4e7"
  version "0.4.4"
  license "Apache-2.0"
