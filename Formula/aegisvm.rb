...
class Aegisvm < Formula
  ...
  url "https://github.com/xfeldman/aegisvm/releases/download/v0.4.1/aegisvm-v0.4.1-darwin-arm64.tar.gz"
  sha256 "a185b4ea0663e884b071585d1cbdb306b66fc1167c654868cd281d5e8275d917"
  version "0.4.1"
  license "Apache-2.0"
